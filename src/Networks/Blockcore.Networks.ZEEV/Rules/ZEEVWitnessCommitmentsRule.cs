...
namespace Blockcore.Networks.ZEEV.Rules
{
    ...
    public class ZEEVWitnessCommitmentsRule : PartialValidationConsensusRule
    {
        /// <inheritdoc />
        ...
        public static void CreateWitnessCommitment(Network network, Block block)
        {
            ...
            byte[] witnessRootHash = BlockWitnessMerkleRoot(block, out var _).ToBytes();
        ...
        public static uint256 BlockWitnessMerkleRoot(Block block, out bool mutated)
        {
            ...
            foreach (ZEEVTransaction tx in block.Transactions.Skip(1))
