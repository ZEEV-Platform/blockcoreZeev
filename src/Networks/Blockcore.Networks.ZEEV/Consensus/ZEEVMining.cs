...
{
    public class ZEEVMining : IPowMining
    {
        ...
        private bool MineBlock(MineBlockContext context)
        {
            ...
            //((ZEEVBlockHeader)block.Header).HashCommitHash = new uint256("3a62731564743864425daac90ec4045f40a33379a3ed786ad8ef6ab8992802bb");
            //((ZEEVBlockHeader)block.Header).HashTreeRoot = new uint256("7c7c2818c605a97178460aad4890df2afcca962cbcb639b812db0af839949798");
            //((ZEEVBlockHeader)block.Header).HashWitnessRoot = new uint256("7c7c2818c605a97178460aad4890df2afcca962cbcb639b812db0af839949798");
            //((ZEEVBlockHeader)block.Header).Time = 1554268735;
            //((ZEEVBlockHeader)block.Header).Version = 0;
            //((ZEEVBlockHeader)block.Header).Bits = new Target(486604799);
