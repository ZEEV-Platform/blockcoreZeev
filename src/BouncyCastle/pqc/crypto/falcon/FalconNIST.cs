...
namespace Org.BouncyCastle.Pqc.Crypto.Falcon
{
    public class FalconNist
    {
        ...
        public FalconNist(SecureRandom random, uint logn, uint noncelen)
        {
            this.logn = logn;
        ...
        public int crypto_sign_keypair(out byte[] pk, out byte[] fEnc, out byte[] gEnc, out byte[] FEnc)
        {
